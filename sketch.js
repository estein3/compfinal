...
let hair = ['black', 'blonde', 'blonde ombre', 'brunette', 'bun', 'funky red', 'red head', 'green', 'pink'];
...
let backgrounds = ['blue background', 'green background', 'pink background', 'purple background', 'yellow background'];
...
function preload(){
 ...
 music = loadSound('music.mp3');
  ...
  // boots.hide();
  bestback = createImg('simpleback.png', 'swag');
  ...
  crewneck = createImg("nebraskacrewneck.png", 'swag');
  fancyshirt = createImg("fancyshirt.png", 'swag');
  graphictee = createImg("codeshirt.png", 'swag'); 
...
//   textAlign(CENTER);
  ...
  a = createElement('p','Shirts!');
  a.position(0, 30);
  a.style('font-size', '40px');
  

  selectshirts.position(0, 110);
  
  b = createElement('p','Pants!');
  b.position(0, 140);
  b.style('font-size', '40px');
  selectpants.position(0, 220);
  
  c = createElement('p','Shoes!');
  c.position(0, 250);
  c.style('font-size', '40px');
  selectshoes.position(0, 330);
  
  d = createElement('p','Hairstyles!');
  d.position(500, 30);
  d.style('font-size', '40px');
  selecthair.position(500, 110);
  
  e = createElement('p','Accessories!');
  e.position(500, 140);
  e.style('font-size', '40px');
  selectaccessories.position(500, 220);
  
  e = createElement('p','P5.DressUp!');
  e.position(160, -50);
  e.style('font-size', '60px');
